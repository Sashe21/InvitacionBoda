  ...
  return (
    <section className="relative py-32 px-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="bg-white/90 backdrop-blur-md p-16 rounded-[2rem] shadow-2xl text-center border border-rose-100/50 relative overflow-hidden">
          
          {/* Decorative corner elements */}
          <div className="absolute top-6 left-6 w-16 h-16 border-l-2 border-t-2 border-rose-300/30 rounded-tl-2xl"></div>
          <div className="absolute top-6 right-6 w-16 h-16 border-r-2 border-t-2 border-rose-300/30 rounded-tr-2xl"></div>
          <div className="absolute bottom-6 left-6 w-16 h-16 border-l-2 border-b-2 border-rose-300/30 rounded-bl-2xl"></div>
          <div className="absolute bottom-6 right-6 w-16 h-16 border-r-2 border-b-2 border-rose-300/30 rounded-br-2xl"></div>
          ...
          <div className="mb-12">
            ...
            {/* Elegant title */}
            <h2 
              className="text-5xl md:text-6xl lg:text-7xl font-light text-rose-800 mb-4 tracking-wide"
              style={{ fontFamily: 'Playfair Display, serif' }}
            >
              <span className="italic font-extralight">Una</span>
              <span className="mx-4 font-normal">Historia</span>
              <br />
              <span className="italic font-extralight">de</span>
              <span className="ml-4 font-normal">Amor</span>
            </h2>
          ...
          <div className="max-w-3xl mx-auto mb-12">
            <p 
              className="text-xl md:text-2xl lg:text-3xl font-light text-gray-700 leading-relaxed mb-8"
              style={{ 
          ...
          <div className="space-y-6">
            <div className="relative">
              <h3 
                className="text-4xl md:text-5xl lg:text-6xl font-light text-rose-900 tracking-wider"
                style={{ 
              ...
              >
                ...
                <span 
                  className="mx-6 text-rose-600 text-5xl md:text-6xl lg:text-7xl"
                  style={{ fontFamily: 'Playfair Display, serif' }}
                >
                  &
                </span>
