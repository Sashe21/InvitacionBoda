...
export default function SectionGalery() {
  ...
  return (
    <>
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: "#fffaef" }}>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl sm:text-5xl font-serif font-bold mb-6" style={{ color: "#1a385f" }}>
              Nuestro Momento
            </h2>

            <p className="text-xl max-w-3xl mx-auto leading-relaxed" style={{ color: "#1a385f" }}>
          ...
          <div className="relative">
            ...
            <button
              onClick={prevSlide}
              className="absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-110"
              style={{ color: "#1a385f" }}
            >
            ...
            <button
              onClick={nextSlide}
              className="absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-white/90 hover:bg-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-110"
              style={{ color: "#1a385f" }}
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {Array.from({ length: Math.ceil(galleryImages.length / 3) }).map((_, slideIndex) => (
                  <div key={slideIndex} className="flex gap-6 min-w-full">
                    {galleryImages.slice(slideIndex * 3, slideIndex * 3 + 3).map((image, imageIndex) => (
                      <div
                        key={image.id}
                        className="group relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 cursor-pointer flex-1"
